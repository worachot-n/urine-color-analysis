"""
Image processing pipeline: red cap detection via HSV masking + contour analysis.
...
detect_red_caps() is kept as a utility for reference-row detection diagnostics.
Sample slot classification uses direct color extraction (no ring detection needed).
"""
